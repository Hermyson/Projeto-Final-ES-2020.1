...
class SessaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sessao" do
    assert_difference('Sessao.count') do
      post sessaos_url, params: { sessao: { data: @sessao.data, hora: @sessao.hora, paciente_id: @sessao.paciente_id, psicologo_id: @sessao.psicologo_id, user_id: @sessao.user_id } }
    end
  ...
  test "should update sessao" do
    patch sessao_url(@sessao), params: { sessao: { data: @sessao.data, hora: @sessao.hora, paciente_id: @sessao.paciente_id, psicologo_id: @sessao.psicologo_id, user_id: @sessao.user_id } }
